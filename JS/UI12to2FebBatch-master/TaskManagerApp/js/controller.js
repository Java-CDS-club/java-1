window.addEventListener("DOMContentLoaded",function(){
   ...
   // document.getElementById(taskList).addEventListener("click",done);
...
function addTask(){
    ...
    if(taskName && taskDesc){
       ...
       // li.className("a");
        ...
        ul.appendChild(li);
        var ul2=document.getElementById("ulus");
      // var li2=document.createElement("li");
        document.getElementById("lius").innerHTML="task pending "+ctr;
